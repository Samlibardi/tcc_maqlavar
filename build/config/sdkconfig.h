...
#define CONFIG_APPTRACE_SV_ENABLE 1
#define CONFIG_APPTRACE_SV_DEST_JTAG 1
#define CONFIG_APPTRACE_SV_TS_SOURCE_CCOUNT 1
#define CONFIG_APPTRACE_SV_MAX_TASKS 16
#define CONFIG_APPTRACE_SV_BUF_WAIT_TMO 500
#define CONFIG_APPTRACE_SV_EVT_OVERFLOW_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_ISR_ENTER_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_ISR_EXIT_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_ISR_TO_SCHED_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_TASK_START_EXEC_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_TASK_STOP_EXEC_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_TASK_START_READY_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_TASK_STOP_READY_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_TASK_CREATE_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_TASK_TERMINATE_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_IDLE_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_TIMER_ENTER_ENABLE 1
#define CONFIG_APPTRACE_SV_EVT_TIMER_EXIT_ENABLE 1
...
#define CONFIG_SYSVIEW_BUF_WAIT_TMO CONFIG_APPTRACE_SV_BUF_WAIT_TMO
#define CONFIG_SYSVIEW_ENABLE CONFIG_APPTRACE_SV_ENABLE
#define CONFIG_SYSVIEW_EVT_IDLE_ENABLE CONFIG_APPTRACE_SV_EVT_IDLE_ENABLE
#define CONFIG_SYSVIEW_EVT_ISR_ENTER_ENABLE CONFIG_APPTRACE_SV_EVT_ISR_ENTER_ENABLE
#define CONFIG_SYSVIEW_EVT_ISR_EXIT_ENABLE CONFIG_APPTRACE_SV_EVT_ISR_EXIT_ENABLE
#define CONFIG_SYSVIEW_EVT_ISR_TO_SCHEDULER_ENABLE CONFIG_APPTRACE_SV_EVT_ISR_TO_SCHED_ENABLE
#define CONFIG_SYSVIEW_EVT_OVERFLOW_ENABLE CONFIG_APPTRACE_SV_EVT_OVERFLOW_ENABLE
#define CONFIG_SYSVIEW_EVT_TASK_CREATE_ENABLE CONFIG_APPTRACE_SV_EVT_TASK_CREATE_ENABLE
#define CONFIG_SYSVIEW_EVT_TASK_START_EXEC_ENABLE CONFIG_APPTRACE_SV_EVT_TASK_START_EXEC_ENABLE
#define CONFIG_SYSVIEW_EVT_TASK_START_READY_ENABLE CONFIG_APPTRACE_SV_EVT_TASK_START_READY_ENABLE
#define CONFIG_SYSVIEW_EVT_TASK_STOP_EXEC_ENABLE CONFIG_APPTRACE_SV_EVT_TASK_STOP_EXEC_ENABLE
#define CONFIG_SYSVIEW_EVT_TASK_STOP_READY_ENABLE CONFIG_APPTRACE_SV_EVT_TASK_STOP_READY_ENABLE
#define CONFIG_SYSVIEW_EVT_TASK_TERMINATE_ENABLE CONFIG_APPTRACE_SV_EVT_TASK_TERMINATE_ENABLE
#define CONFIG_SYSVIEW_EVT_TIMER_ENTER_ENABLE CONFIG_APPTRACE_SV_EVT_TIMER_ENTER_ENABLE
#define CONFIG_SYSVIEW_EVT_TIMER_EXIT_ENABLE CONFIG_APPTRACE_SV_EVT_TIMER_EXIT_ENABLE
#define CONFIG_SYSVIEW_MAX_TASKS CONFIG_APPTRACE_SV_MAX_TASKS
#define CONFIG_SYSVIEW_TS_SOURCE_CCOUNT CONFIG_APPTRACE_SV_TS_SOURCE_CCOUNT
